...
const admin_players_controller_1 = require("./admin-players.controller");
...
exports.PlayersModule = PlayersModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [players_controller_1.PlayersController, admin_players_controller_1.AdminPlayersController],
        providers: [players_service_1.PlayersService, admin_players_service_1.AdminPlayersService, challenge_rules_service_1.ChallengeRulesService],
