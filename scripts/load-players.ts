...
function generateUsername(nombre: string, existingUsernames: Set<string>): string {
...
const rankingOrden = [
  "Claudio Pinilla",  // 1
  "Juan Pablo Morales", "Ismael soto", "Lester Montre",  // 2, 3, 4
  "Hernán Rojas", "Claudio Pineda", "Gerardo Galdame", "Piero Cantillana Godoy",  // 5-8
  "Héctor Mondaca", "Diego Quijada", "Diego Suárez", "CRISTIAN ORDOÑEZ",  // 9-12
  "Cristián González", "Oscar Eliseo Perez Perez", "Randolfo Tapia", "Luis enrique miranda lorca", "Rodrigo Becerra",  // 13-17
  "Gonzalo carbacho", "Rodrigo Saez", "Luis Raúl Correa", "Oscar Pérez Jr", "Vicente Soto",  // 18-22
  "Gerardo Pérez", "Mateo Carvacho", "Daniel Soto muñoz", "Gustavo Díaz", "Leandro Lobos", "Diego Fuenzalida",  // 23-28
  "Juan Parraguez", "Carlos Guzmán", "Diego Tapia Diaz", "Daniel Soto",  // 29-32
];
